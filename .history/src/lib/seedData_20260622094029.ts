...
export const defaultGalleryImages: GalleryImage[] = [
  { id: "gallery_1", title: "Annual Day Celebration", image: "/images/gallery1.jpg", category: "Events", order: 1, isActive: true, updatedAt: new Date().toISOString() },
  { id: "gallery_2", title: "Science Fair 2026", image: "/images/gallery2.jpg", category: "Academic", order: 2, isActive: true, updatedAt: new Date().toISOString() },
  { id: "gallery_3", title: "Sports Day", image: "/images/gallery3.jpg", category: "Sports", order: 3, isActive: true, updatedAt: new Date().toISOString() },
  { id: "gallery_4", title: "Art Exhibition", image: "/images/gallery4.jpg", category: "Arts", order: 4, isActive: true, updatedAt: new Date().toISOString() },
  { id: "gallery_5", title: "Classroom Learning", image: "/images/gallery5.jpg", category: "Academic", order: 5, isActive: true, updatedAt: new Date().toISOString() },
  { id: "gallery_6", title: "Graduation Ceremony", image: "/images/gallery6.jpg", category: "Events", order: 6, isActive: true, updatedAt: new Date().toISOString() },
];

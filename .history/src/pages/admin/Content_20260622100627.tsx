      ...
      <AdminLayout>
        ...
        <Tabs defaultValue="hero" className="space-y-6">
          <TabsList className="bg-white border border-slate-200 flex flex-wrap h-auto gap-1 p-1">
            ...
            <TabsTrigger value="about" className="text-xs sm:text-sm">Vision & Mission</TabsTrigger>
            <TabsTrigger value="about-section" className="text-xs sm:text-sm">About Section</TabsTrigger>
            <TabsTrigger value="about-page" className="text-xs sm:text-sm">About Page</TabsTrigger>
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <Input value={currentForm.aboutImage1} onChange={(e) => setForm((p) => ({ ...p, aboutImage1: e.target.value }))} placeholder="Image URL" />
          </div>
          <div>
            <label className="text-sm font-medium text-slate-700">About Image 2</label>
            <Input value={currentForm.aboutImage2} onChange={(e) => setForm((p) => ({ ...p, aboutImage2: e.target.value }))} placeholder="Image URL" />
          </div>
          <div>
            <label className="text-sm font-medium text-slate-700">About Image 3</label>
            <Input value={currentForm.aboutImage3} onChange={(e) => setForm((p) => ({ ...p, aboutImage3: e.target.value }))} placeholder="Image URL" />
          </div>
          <div>
            <label className="text-sm font-medium text-slate-700">About Image 4</label>
            <Input value={currentForm.aboutImage4} onChange={(e) => setForm((p) => ({ ...p, aboutImage4: e.target.value }))} placeholder="Image URL" />
          </div>
        </div>
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="space-y-2">
      ...
      <CardContent className="p-6 space-y-6">
        <div className="space-y-4 rounded-xl border border-slate-200 p-4">
          ...
          <div>
            ...
            <Input placeholder="/images/hero1.jpg or https://..." value={currentForm.aboutPageIntroImage} onChange={(e) => setForm((p) => ({ ...p, aboutPageIntroImage: e.target.value }))} />
          </div>
          <div>

      ...
      <AdminLayout>
        ...
        <Tabs defaultValue="hero" className="space-y-6">
          <TabsList className="flex h-auto w-full flex-wrap justify-start gap-1 rounded-lg border border-slate-200 bg-slate-100 p-1">
            <TabsTrigger value="hero" className={contentTabClass}>Hero Slides</TabsTrigger>
            <TabsTrigger value="about" className={contentTabClass}>About</TabsTrigger>
            <TabsTrigger value="stats" className={contentTabClass}>Stats</TabsTrigger>
            <TabsTrigger value="values" className={contentTabClass}>Core Values</TabsTrigger>
            <TabsTrigger value="testimonials" className={contentTabClass}>Testimonials</TabsTrigger>
            <TabsTrigger value="team" className={contentTabClass}>Team</TabsTrigger>
            <TabsTrigger value="careers" className={contentTabClass}>Careers</TabsTrigger>
            <TabsTrigger value="partners" className={contentTabClass}>Partners</TabsTrigger>
          </TabsList>
    ...
    <Card className="rounded-lg shadow-sm">
      <CardContent className="p-6 space-y-6">
        <div className="space-y-4 border-b border-slate-200 pb-6">
          <div>
            <h3 className="font-semibold text-slate-900">Homepage About Section</h3>
            <p className="text-sm text-slate-500">Manage the homepage About content, images, and feature cards.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              {currentForm.aboutImage1 ? <img src={currentForm.aboutImage1} alt="About image 1" className="h-24 w-40 rounded object-cover border border-slate-200" /> : null}
            </div>
            <div className="space-y-2">
              ...
              {currentForm.aboutImage2 ? <img src={currentForm.aboutImage2} alt="About image 2" className="h-24 w-40 rounded object-cover border border-slate-200" /> : null}
            </div>
            <div className="space-y-2">
              ...
              {currentForm.aboutImage3 ? <img src={currentForm.aboutImage3} alt="About image 3" className="h-24 w-40 rounded object-cover border border-slate-200" /> : null}
            </div>
            <div className="space-y-2">
              ...
              {currentForm.aboutImage4 ? <img src={currentForm.aboutImage4} alt="About image 4" className="h-24 w-40 rounded object-cover border border-slate-200" /> : null}
            </div>
          </div>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2">
        ...
        <div className="space-y-4 border-b border-slate-200 pb-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-slate-900">About Page Introduction</h3>
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">Add, edit, and remove partner logos and links.</p>
        </div>
        <Button
          type="button"
          onClick={() => {
          ...
          className="bg-black-600 hover:bg-grey-700"
        >
          <Plus className="mr-1 h-4 w-4" /> {showNewForm ? "Close" : "Add Partner"}
        </Button>
      </div>
      ...
      {showNewForm && (
        <Card>
          <CardContent className="p-4 space-y-3">
            <div className="grid sm:grid-cols-2 gap-3">
              <Input value={newPartner.name} onChange={(e) => setNewPartner((prev) => ({ ...prev, name: e.target.value }))} placeholder="Partner Name" />
              <Input value={newPartner.website} onChange={(e) => setNewPartner((prev) => ({ ...prev, website: e.target.value }))} placeholder="Website URL" />
            </div>
            <div className="flex flex-wrap items-center gap-3">
              <Input type="file" accept="image/*" className="max-w-sm" onChange={(e) => handleCreateImageUpload(e.target.files?.[0])} />
              {uploadingNewImage && <span className="text-sm text-slate-500">Uploading...</span>}
            </div>
            {newPartner.logo ? (
              <img src={newPartner.logo} alt={newPartner.name || "New partner"} className="h-16 w-32 rounded object-contain border border-slate-200 bg-slate-50 p-2" />
            ) : (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Switch checked={newPartner.isActive} onCheckedChange={(value) => setNewPartner((prev) => ({ ...prev, isActive: value }))} />
                <span className="text-sm text-slate-600">Active</span>
              </div>
              <Button type="button" onClick={handleAdd} className="bg-green-600 hover:bg-green-700">
        ...
        return (
          <Card key={item.id}>
            <CardContent className="p-4 space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Input type="file" accept="image/*" className="max-w-sm" onChange={(e) => handleNewImageUpload(item.id, e.target.files?.[0])} />
                {(uploadingNewImage || uploadingId === item.id) && <span className="text-sm text-slate-500">Uploading...</span>}
              </div>
              {logoValue ? (
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <Button size="sm" variant="outline" className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700" onClick={() => handleRemove(item.id)}>
                    <Minus className="mr-1 h-4 w-4" /> Remove
                  </Button>
                  <Button size="sm" onClick={() => handleSave(item.id)}><Save className="h-4 w-4 mr-1" /> Save</Button>
                </div>

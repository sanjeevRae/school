...
function AboutTab() {
  ...
  const handleHighlightIconUpload = async (
    iconKey:
      | "aboutPageHighlight1Icon"
      | "aboutPageHighlight2Icon"
      | "aboutPageHighlight3Icon"
    ...
    try {
      setUploadingImageKey(iconKey);
      const result = await uploadImage(file);
      setForm(prev => ({ ...prev, [iconKey]: result.url }));
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                <Input
                  ...
                  className="max-w-sm"
                  onChange={e =>
                    handleHighlightIconUpload(
                      "aboutPageHighlight1Icon",
                      e.target.files?.[0]
                    )
                  }
                />
                {uploadingImageKey === "aboutPageHighlight1Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight1Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight1Icon}
                      alt="Highlight 1 icon"
                      className="h-12 w-12 rounded object-contain border border-slate-200 bg-slate-50 p-2"
                    />
                    <Button
                      type="button"
                      size="sm"
                      ...
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight1Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>
                  </>
                ) : null}
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                />
                {uploadingImageKey === "aboutPageHighlight2Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight2Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight2Icon}
                      alt="Highlight 2 icon"
                      className="h-12 w-12 rounded object-contain border border-slate-200 bg-slate-50 p-2"
                    />
                    <Button
                      type="button"
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight2Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                />
                {uploadingImageKey === "aboutPageHighlight3Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight3Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight3Icon}
                    ...
                    <Button
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight3Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                />
                {uploadingImageKey === "aboutPageHighlight4Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight4Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight4Icon}
                      alt="Highlight 4 icon"
                      className="h-12 w-12 rounded object-contain border border-slate-200 bg-slate-50 p-2"
                    />
                    <Button
                      type="button"
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight4Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                />
                {uploadingImageKey === "aboutPageHighlight5Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight5Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight5Icon}
                      alt="Highlight 5 icon"
                      className="h-12 w-12 rounded object-contain border border-slate-200 bg-slate-50 p-2"
                    />
                    <Button
                      type="button"
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight5Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-1">
                ...
                />
                {uploadingImageKey === "aboutPageHighlight6Icon" && (
                  <span className="text-sm text-slate-500">Uploading...</span>
                )}
                {currentForm.aboutPageHighlight6Icon ? (
                  <>
                    <img
                      src={currentForm.aboutPageHighlight6Icon}
                      alt="Highlight 6 icon"
                      className="h-12 w-12 rounded object-contain border border-slate-200 bg-slate-50 p-2"
                    />
                    <Button
                      type="button"
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 hover:text-red-700"
                      onClick={() =>
                        setForm(p => ({ ...p, aboutPageHighlight6Icon: "" }))
                      }
                    >
                      <Minus className="mr-1 h-4 w-4" /> Remove Icon
                    </Button>

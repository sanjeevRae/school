                    ...
                    {newImage.images.map((image, index) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          size="icon"
                          variant="outline"
                          className="absolute right-1 top-1 h-7 w-7 border-red-200 bg-white/95 text-red-600 hover:bg-red-50 hover:text-red-700"
                          onClick={(e) => {
                            e.stopPropagation();
                    ...
                    {currentImages.map((image: string, index: number) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            handleRemoveExistingImage(img.id, index);
                          }}
                        >
                          <Trash2 className="h-3.5 w-3.5" />
                        </Button>

      ...
      <AdminLayout>
        ...
        <Tabs defaultValue="general" className="space-y-6">
          <TabsList className="bg-white border border-slate-200 flex flex-wrap h-auto gap-1">
            ...
            <TabsTrigger value="about-page">
              <Image className="h-4 w-4 mr-1" /> About Page
            </TabsTrigger>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4 rounded-xl border border-slate-200 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch checked={form.aboutPageIntroVisible} onCheckedChange={(value) => setForm((p) => ({ ...p, aboutPageIntroVisible: value }))} />
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-slate-700">Intro Label</label>
                      <Input placeholder="Our Story" value={form.aboutPageIntroLabel} onChange={(e) => setForm((p) => ({ ...p, aboutPageIntroLabel: e.target.value }))} />
                    </div>
                    <div>
                      <label className="text-sm font-medium text-slate-700">Intro Title</label>
                      <Input placeholder="School name or custom title" value={form.aboutPageIntroTitle} onChange={(e) => setForm((p) => ({ ...p, aboutPageIntroTitle: e.target.value }))} />
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Intro Image</label>
                    <Input placeholder="/images/hero1.jpg or https://..." value={form.aboutPageIntroImage} onChange={(e) => setForm((p) => ({ ...p, aboutPageIntroImage: e.target.value }))} />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-slate-700">Intro Description</label>
                    <Textarea placeholder="Write the About page introduction text" rows={8} value={form.aboutText} onChange={(e) => setForm((p) => ({ ...p, aboutText: e.target.value }))} />
                  </div>
                </div>
                ...
                <div className="space-y-4 rounded-xl border border-slate-200 p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch checked={form.aboutPageHighlightsVisible} onCheckedChange={(value) => setForm((p) => ({ ...p, aboutPageHighlightsVisible: value }))} />
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-slate-700">Section Label</label>
                      <Input placeholder="Why Choose Us" value={form.aboutPageHighlightsLabel} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlightsLabel: e.target.value }))} />
                    </div>
                    <div>
                      <label className="text-sm font-medium text-slate-700">Section Title</label>
                      <Input placeholder="What Sets Us Apart" value={form.aboutPageHighlightsTitle} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlightsTitle: e.target.value }))} />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 1 Title</label>
                      <Input placeholder="STEAM Curriculum" value={form.aboutPageHighlight1Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight1Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 1 Description</label>
                      <Textarea placeholder="Card 1 description" value={form.aboutPageHighlight1Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight1Desc: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 2 Title</label>
                      <Input placeholder="Small Class Sizes" value={form.aboutPageHighlight2Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight2Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 2 Description</label>
                      <Textarea placeholder="Card 2 description" value={form.aboutPageHighlight2Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight2Desc: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 3 Title</label>
                      <Input placeholder="Holistic Development" value={form.aboutPageHighlight3Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight3Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 3 Description</label>
                      <Textarea placeholder="Card 3 description" value={form.aboutPageHighlight3Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight3Desc: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 4 Title</label>
                      <Input placeholder="Quality Faculty" value={form.aboutPageHighlight4Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight4Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 4 Description</label>
                      <Textarea placeholder="Card 4 description" value={form.aboutPageHighlight4Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight4Desc: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 5 Title</label>
                      <Input placeholder="Safe Environment" value={form.aboutPageHighlight5Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight5Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 5 Description</label>
                      <Textarea placeholder="Card 5 description" value={form.aboutPageHighlight5Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight5Desc: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-slate-700">Card 6 Title</label>
                      <Input placeholder="15+ Years" value={form.aboutPageHighlight6Title} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight6Title: e.target.value }))} />
                      <label className="text-sm font-medium text-slate-700">Card 6 Description</label>
                      <Textarea placeholder="Card 6 description" value={form.aboutPageHighlight6Desc} onChange={(e) => setForm((p) => ({ ...p, aboutPageHighlight6Desc: e.target.value }))} />
                    </div>
                  </div>
                </div>

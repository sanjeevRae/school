...
import { Save, School, Phone, Globe, FileText } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <Input type="file" accept="image/*" className="max-w-sm" onChange={(e) => handleLogoUpload(e.target.files?.[0])} />
                    {uploadingLogo && <span className="text-sm text-slate-500">Uploading...</span>}
                  </div>
                  {form.logo ? (
                    <img src={form.logo} alt={form.schoolName || "School logo"} className="h-20 w-20 rounded object-contain border border-slate-200 bg-slate-50 p-2" />
                  ) : (

...
export default function About() {
  ...
  const highlights = [
    { icon: highlightIcons[0], title: settings?.aboutPageHighlight1Title || "STEAM Curriculum", desc: settings?.aboutPageHighlight1Desc || "Integrated approach to Science, Technology, Engineering, Arts & Mathematics" },
    { icon: highlightIcons[1], title: settings?.aboutPageHighlight2Title || "Small Class Sizes", desc: settings?.aboutPageHighlight2Desc || "Personalized attention with optimal student-teacher ratios" },
    { icon: highlightIcons[2], title: settings?.aboutPageHighlight3Title || "Holistic Development", desc: settings?.aboutPageHighlight3Desc || "Focus on academic, physical, emotional, and social growth" },
    { icon: highlightIcons[3], title: settings?.aboutPageHighlight4Title || "Quality Faculty", desc: settings?.aboutPageHighlight4Desc || "Experienced and passionate educators" },
    { icon: highlightIcons[4], title: settings?.aboutPageHighlight5Title || "Safe Environment", desc: settings?.aboutPageHighlight5Desc || "Secure campus with modern facilities" },
    { icon: highlightIcons[5], title: settings?.aboutPageHighlight6Title || "15+ Years", desc: settings?.aboutPageHighlight6Desc || "Established track record of excellence" },

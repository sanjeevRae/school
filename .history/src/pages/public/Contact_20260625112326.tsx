...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!emailJsServiceId || !emailJsTemplateId || !emailJsPublicKey) {
      toast.error("EmailJS is not configured. Add VITE_EMAILJS_SERVICE_ID, VITE_EMAILJS_TEMPLATE_ID, and VITE_EMAILJS_PUBLIC_KEY to your env.");
      return;
    }
    ...
    try {
      ...
      const details = error?.text || error?.message || error?.status || "Failed to send message.";
      toast.error(`Email send failed: ${details}`);
